	...
	if( $cart_items ) {
		foreach( $cart_items as $key => $cart_item ) {
			...
			if( edd_has_variable_prices( $cart_item['id'] ) ) {
				$body['data']['price_id']   = $cart_item['item_number']['options']['price_id'];
				$body['data']['price_name'] = edd_get_price_option_name( $cart_item['id'], $cart_item['item_number']['options']['price_id'] );
				$body['data']['quantity']   = $cart_item['item_number']['quantity'];
			} else {
				$body['data']['quantity']   = $cart_item['quantity'];
			}
